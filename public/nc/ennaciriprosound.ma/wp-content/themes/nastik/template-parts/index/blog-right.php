                    ...
                    <div class="content">
                        ...
                        <section class="header-section hidden-section" data-scrollax-parent="true">
                            ...
                            <div class="container">
								...
								<?php if ( is_category() ) { ?>
								<h1><?php if(!empty($nastik_options['cat-page-title'])):?><?php echo esc_html(nastik_AfterSetupTheme::return_thme_option('cat-page-title',''));?><?php else :?><?php esc_html_e('Category','nastik');?><?php endif;?></h1>
                                <p><?php single_cat_title( '', true ); ?></p>
								<?php } else if ( is_tag() ) { ?>
                                <h1><?php if(!empty($nastik_options['tag-page-title'])):?><?php echo esc_html(nastik_AfterSetupTheme::return_thme_option('tag-page-title',''));?><?php else :?><?php esc_html_e('Tag','nastik');?><?php endif;?></h1>
                                <p><?php single_tag_title(); ?></p>
								<?php } else if ( is_archive() ) { ?>
								<h1><?php if(!empty($nastik_options['arch-page-title'])):?><?php echo esc_attr(nastik_AfterSetupTheme::return_thme_option('arch-page-title',''));?><?php else :?><?php esc_html_e('Archive','nastik');?><?php endif;?></h1>
                                <p><?php single_month_title(' '); ?></p>
								<?php } else { ?>
								<h1><?php if(!empty($nastik_options['blogtitle'])):?><?php echo esc_attr(nastik_AfterSetupTheme::return_thme_option('blogtitle',''));?><?php else :?><?php esc_html_e('My Blog','nastik');?><?php endif;?></h1>
                                <p><?php echo esc_attr(nastik_AfterSetupTheme::return_thme_option('blog_sub_title',''));?></p>
								<?php } ?>
                                </div>
