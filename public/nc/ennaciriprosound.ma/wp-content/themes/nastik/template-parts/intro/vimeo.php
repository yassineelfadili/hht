<div class="hero-wrap fl-wrap full-height scroll-con-sec hidden-section" id="sec1" data-scrollax-parent="true">
				...
				<?php 
					...
					if(get_post_meta($post->ID,'rnr_wr_intro_vimeo_video_title_tag',true)=='h2') { 
						$nastik_title_tag ='h2';
					} 
					else if(get_post_meta($post->ID,'rnr_wr_intro_vimeo_video_title_tag',true)=='h3') {
						$nastik_title_tag ='h3';												
					}
					else if(get_post_meta($post->ID,'rnr_wr_intro_vimeo_video_title_tag',true)=='h4') {
						$nastik_title_tag ='h4';												
					}
					else if(get_post_meta($post->ID,'rnr_wr_intro_vimeo_video_title_tag',true)=='h5') {
						$nastik_title_tag ='h5';												
					}
					else if(get_post_meta($post->ID,'rnr_wr_intro_vimeo_video_title_tag',true)=='h6') {
						$nastik_title_tag ='h6';												
					}
					else {
						$nastik_title_tag ='h1';
				...
				<<?php echo esc_attr($nastik_title_tag);?> class="hero-intro-title"><?php echo do_shortcode(get_post_meta($post->ID,'rnr_ns_intro_vimeo_video_title',true)); ?></<?php echo esc_attr($nastik_title_tag);?>>
				<?php endif;?>
