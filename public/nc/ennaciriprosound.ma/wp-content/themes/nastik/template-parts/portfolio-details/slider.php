 ...
 <!-- hero-slider-wrap --> 
                    <div class="fs-slider-wrap full-height fl-wrap">
                            ...
                            <div class="swiper-container">
                                <div class="swiper-wrapper" >
                                    ...
                                    <div class="swiper-slide hov_zoom">
										...
										<?php endif;?>
										<?php $nastik_back_image = rwmb_meta( 'rnr_ns_port_details_page_header_back_st3','type=image&size=' ); ?>
										...
										<?php foreach ( $nastik_back_image as $nastik_back_images ){ ?>
                                            ...
                                            <a href="<?php echo esc_url(($nastik_back_images['url']));?>" class="box-media-zoom   popup-image"><i class="fal fa-search"></i></a>
										<?php } ;?>
										<?php } else { ?>
										...
										<?php } ;?>
                                            <div class="half-hero-wrap">
												...
												<?php if (( get_post_meta($post->ID,'rnr_ns_port_details_page_header_hortitle_st3',true))):?>
                                                <div class="rotate_text"><?php echo esc_html(get_post_meta($post->ID,'rnr_ns_port_details_page_header_hortitle_st3',true)); ?></div>
												<?php endif;?>
												<?php if (( get_post_meta($post->ID,'rnr_ns_port_details_page_header_title_st3',true))):?>
                                                <h1><?php echo do_shortcode(get_post_meta($post->ID,'rnr_ns_port_details_page_header_title_st3',true)) ?></h1>
												<?php else : ?>
                                                <h1><?php the_title();?></h1>
												<?php endif;?>
												<?php if (( get_post_meta($post->ID,'rnr_ns_port_details_page_header_desc_st3',true))):?>
                                                <h4><?php echo esc_html(get_post_meta($post->ID,'rnr_ns_port_details_page_header_desc_st3',true)); ?></h4>
												<?php endif;?>
                                                <div class="clearfix"></div>
                                                <a href="#sec1" class="btn   fl-btn color-bg custom-scroll-link"><?php if(get_post_meta($post->ID,'rnr_ns_port_details_page_header_translate_op2_st2',true)):?><?php echo esc_html(get_post_meta($post->ID,'rnr_ns_port_details_page_header_translate_op2_st2',true));?> <?php else : ?><?php esc_html_e('View Details','nastik');?><?php endif;?></a>
                                            </div>
                                        </div>
                                    </div>
                                    <!-- swiper-slide-->
                        ...
                        <div class="scroll-down-wrap scdw2 hiddec-anim">
                            ...
                            <span><?php if(get_post_meta($post->ID,'rnr_ns_port_details_page_header_translate_op1_st2',true)):?><?php echo esc_html(get_post_meta($post->ID,'rnr_ns_port_details_page_header_translate_op1_st2',true));?> <?php else : ?><?php esc_html_e('Scroll down  to discover','nastik');?><?php endif;?></span>
                        </div>
                    </div>
