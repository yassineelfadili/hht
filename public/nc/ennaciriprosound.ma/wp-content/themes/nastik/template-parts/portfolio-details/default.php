                    ...
                    <div class="content">
                        ...
                        <section>
                            ...
                            <div class="container">
								...
								?>
                                <div class="gallery-items min-pad  lightgallery   fl-wrap  hiddec-anim" <?php if(get_post_meta($post->ID,'rnr_ns_port_dtpage_load_more',true)=='st2'){ ?>data-load-item="<?php echo esc_attr($nastik_loadpost);?>" <?php } else { ?>data-load-item="4000000"<?php } ;?> data-button-text="<?php if(get_post_meta($post->ID,'rnr_ns_port_dtpage_translate_opt5',true)):?><?php echo esc_html(get_post_meta($post->ID,'rnr_ns_port_dtpage_translate_opt5',true));?> <?php else : ?><?php esc_html_e('Load More','nastik');?><?php endif;?>">
												<?php
