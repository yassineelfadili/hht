...
<!-- fixed-column-wrap -->       
					...
					<?php $nastik_back_image = rwmb_meta( 'rnr_ns_port_details_page_header_back_st5','type=image&size=' ); ?>
                            ...
                            <div class="fixed-top-panel fl-wrap">
                                <div class="sp-fix-header fl-wrap">
                                    <div class="scroll-down-wrap">
                                        ...
                                        <span><?php if(get_post_meta($post->ID,'rnr_ns_port_details_page_header_translate_op1_st5',true)):?><?php echo esc_html(get_post_meta($post->ID,'rnr_ns_port_details_page_header_translate_op1_st5',true));?> <?php else : ?><?php esc_html_e('Scroll down  to discover','nastik');?><?php endif;?></span>
                                    </div>
                                    <?php 
									global $nastik_buton_class;
									if(get_post_meta($post->ID,'rnr_ns_port_details_page_header_url_type_st5',true)!='st2'){
									$nastik_buton_class="ajax";
									} ;?>
									<?php if(get_post_meta($post->ID,'rnr_ns_port_details_page_header_button_url_st5',true)):?>
                                    <a href="<?php echo esc_url(get_post_meta($post->ID,'rnr_ns_port_details_page_header_button_url_st5',true));?>" class="<?php echo sanitize_html_class($nastik_buton_class);?> back-to-home-btn"><span><?php if(get_post_meta($post->ID,'rnr_ns_port_details_page_header_button_text_st5',true)):?><?php echo esc_html(get_post_meta($post->ID,'rnr_ns_port_details_page_header_button_text_st5',true));?> <?php else : ?><?php esc_html_e('Back to portfolio','nastik');?><?php endif;?></span></a>
									<?php endif;?>
                                </div>
                            </div>
                            <!--fixed-top-panel end-->
                            ...
                            <section   class="hidden-section">
                                ...
                                <div class="container">
                                    <div class="section-title fl-wrap">
                                        <?php if (( get_post_meta($post->ID,'rnr_ns_port_details_page_header_title_st5',true))):?>
                                        <h3><?php echo esc_html(get_post_meta($post->ID,'rnr_ns_port_details_page_header_title_st5',true)); ?></h3>
										<?php else: ?>
                                        <h3><?php the_title();?></h3>
										<?php endif;?>
                                        <?php if (( get_post_meta($post->ID,'rnr_ns_port_details_page_header_desc_st5',true))):?>	
										<p><?php echo esc_html(get_post_meta($post->ID,'rnr_ns_port_details_page_header_desc_st5',true)); ?>  </p>
										<?php endif;?>
                                    </div>
                                    <!-- media-wrap-->
                                    ...
                                    <?php if (( get_post_meta($post->ID,'rnr_ns_port_details_page_header_right_title_st5',true))):?><div class="sec-number"><?php echo esc_html(get_post_meta($post->ID,'rnr_ns_port_details_page_header_right_title_st5',true)); ?></div>
								<?php endif;?>
                                </div>
