                    ...
                    <div class="hero-wrap fl-wrap full-height scroll-con-sec hidden-section" id="sec1" data-scrollax-parent="true">
						...
						<div class="video-container">
                                <video autoplay playsinline loop muted  class="bgvid">
                                    <source src="<?php echo esc_url(get_post_meta($post->ID,'rnr_ns_port_details_page_header_video_id_st8',true)); ?>" type="video/mp4">
                                </video>
                        </div>
                        ...
                        <div class="half-hero-wrap">
                            <div class="pr-bg"></div>
							<?php if (( get_post_meta($post->ID,'rnr_ns_port_details_page_header_hortitle_st8',true))):?>
                            <div class="rotate_text">
                                <div><?php echo esc_html(get_post_meta($post->ID,'rnr_ns_port_details_page_header_hortitle_st8',true)); ?></div>
                            </div>
							<?php endif;?>
							<?php if (( get_post_meta($post->ID,'rnr_ns_port_details_page_header_title_st8',true))):?>
                            <h1><?php echo do_shortcode(get_post_meta($post->ID,'rnr_ns_port_details_page_header_title_st8',true)) ?></h1>
							<?php else : ?>
                            <h1><?php the_title();?></h1>
							<?php endif;?>
                            <?php if (( get_post_meta($post->ID,'rnr_ns_port_details_page_header_desc_st8',true))):?>
                            <h4><?php echo esc_html(get_post_meta($post->ID,'rnr_ns_port_details_page_header_desc_st8',true)); ?></h4>
							<?php endif;?>
                            <div class="clearfix"></div>
                            <a href="#sec2" class="btn fl-btn custom-scroll-link  color-bg"><?php if(get_post_meta($post->ID,'rnr_ns_port_details_page_header_translate_op2_st8',true)):?><?php echo esc_html(get_post_meta($post->ID,'rnr_ns_port_details_page_header_translate_op2_st8',true));?> <?php else : ?><?php esc_html_e('View More Details','nastik');?><?php endif;?></a>
                        </div>
                        ...
                        <div class="scroll-down-wrap sdw_hero">
                            ...
                            <span><?php if(get_post_meta($post->ID,'rnr_ns_port_details_page_header_translate_op1_st8',true)):?><?php echo esc_html(get_post_meta($post->ID,'rnr_ns_port_details_page_header_translate_op1_st8',true));?> <?php else : ?><?php esc_html_e('Scroll down  to discover','nastik');?><?php endif;?></span>
                        </div>
                    </div>
