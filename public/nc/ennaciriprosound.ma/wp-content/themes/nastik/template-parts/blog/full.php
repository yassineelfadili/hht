...
<!-- fixed-column-wrap -->       
                    <div class="fixed-column-wrap">
                        ...
                        <div class="fixed-column-tilte fcw-title"><span><?php if (( get_post_meta($post->ID,'rnr_ns_blog_header_title_opt',true))):?><?php echo esc_html(get_post_meta($post->ID,'rnr_ns_blog_header_title_opt',true)); ?><?php else: ?><?php the_title();?><?php endif;?></span></div>
                    </div>
...
<!-- column-wrap -->
                    <div class="column-wrap  ">
                        ...
                        <div class="content">
							...
							$nastik_count = $nastik_loop->post_count;
							?>
