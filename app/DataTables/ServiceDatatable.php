        ...
        return datatables()
            ...
            ->addColumn('image', function ($query) {
                if (isset($query->image)) {
                    return '<img src="' . asset(path_service_image() . $query->image) . '" class="wdh-90" alt="' . __('No Image') . '"/>';
                } else {
            ...
            ->addColumn(
                ...
                function ($data) {
                    ...
                    if (auth()->user()->can('service-edit')) {
                        $btn = $btn . '<a href="' . route("service.edit", $data->id) . '"><i class="ik ik-edit"></i></a>';
                    }
                    if (auth()->user()->can('service-delete')) {
                        $btn = $btn . '<a class="delete" href="' . route("service.delete", $data->id) . '"><i class="ik ik-trash-2"></i></a>';
                    }
                    return $btn;
                }
            )
