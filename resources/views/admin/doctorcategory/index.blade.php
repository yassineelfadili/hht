                    ...
                    <div class="card-header">
                        ...
                        @can('category-create')
                            <a class="btn btn-primary ml-auto"
                                href="{{ route('doctor.category.create') }}">{{ __('Add Category') }}</a>
                        @endcan
                    </div>
                    <div class="card-body">
                        {{ $dataTable->table() }}
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLongTitle">{{ __('Doctor Category') }}</h5>
                    ...
                    <div class="modal-body">
                        <div class="card">
                            <div class="card-body">
                                <h5 class="card-title">{{ __('Category Detail') }}</h5>
                            </div>
                            <ul class="list-group list-group-flush">
                                <li class="list-group-item">{{ __('Name:') }} {{ $category->name }}</li>
