...
@section('title', __('Gallery Create'))
@section('content')
            ...
            <div class="row align-items-end">
                <div class="col-6">
                    <div class="page-header-title">
                        ...
                        <div class="d-inline">
                            <h5>{{ __('Add Gallery')}}</h5>
                            <span>{{ __('Add new gallery')}}</span>
                        </div>
                    </div>
                </div>
                <div class="col-6">
                        ...
                        <div class="card-body">
                            <div class="image-group">
                                <div class="form-group">
                                    ...
                                    <img id="target" class="cus-mw-200" src="{{ asset(path_noimage_image().'no-image-200.jpg') }}" alt="{{ __('test') }}">
                                </div>
                                <div class="form-group">
                            ...
                            <div class="form-group">
                                <label for="">{{ __('Service Name')}} <span class="text-danger">*</span> </label>
                                <select class="form-control select2" name="service_id">
                                    @foreach ($services as $service_name)
                                    <option value="{{ $service_name->id }}">{{ Str::ucfirst($service_name->title) }}</option>
                                    @endforeach
                                </select>
