                        ...
                        <div class="card-body">
                            <div class="image-group">
                                <div class="form-group">
                                    ...
                                    <img id="target" class="cus-mw-200" src="{{ asset(path_gallery_image() . $gallery->image) }}" alt="{{ __('test') }}">
                                </div>
                                <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control select2" name="service_id">
                                    ...
                                    <option {{ $gallery->service_id ==  $service_name->id ? 'selected' : ''}} value="{{ $service_name->id }}">{{ Str::ucfirst($service_name->title) }}</option>
                                    @endforeach
                                </select>
