                        ...
                        <div class="card-body">
                            @foreach (allLanguages() as $lang)
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="title" name="title_{{$lang->prefix}}" placeholder="{{ __('Title here') }}" value="{{ $news->translateOrDefault($lang->prefix)->title }}">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea id="description" name="description_{{$lang->prefix}}" class="form-control" rows="4">{{ $news->translateOrDefault($lang->prefix)->description }}</textarea>
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea id="details" name="details_{{$lang->prefix}}" class="form-control html-editor">{{ $news->translateOrDefault($lang->prefix)->details }}</textarea>
