                            ...
                            @foreach (allLanguages() as $lang)
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="title" name="title_{{ $lang->prefix }}"
                                        ...
                                        value="{{ section_title('news-section') ? section_title('news-section')->translateOrDefault($lang->prefix)->title : '' }}">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea id="description" name="description_{{ $lang->prefix }}" class="form-control"
                                        rows="5">{{ section_title('news-section') ? section_title('news-section')->translateOrDefault($lang->prefix)->description : '' }}</textarea>
