                    ...
                    <div class="card-block">
                        <div class="row align-items-center">
                            <div class="col-8">
                                ...
                                <p class="mb-0">{{ __('Total Earning') }}</p>
                            </div>
                            <div class="col-4 text-right">
                        ...
                        @foreach ($doctors as $doctor)
                            <div class="align-middle mb-25">
                                <img src="{{ isset($doctor->image) ? asset(path_user_image() . $doctor->image) : Avatar::create($doctor->name)->toBase64() }}"
                                    alt="{{ __('user image') }}" class="rounded-circle img-40 align-top mr-15">
                                ...
                                <tbody>
                                    @foreach ($appointment as $app)
                                        <tr>
                                            ...
                                            <td>{{ $app->paymentmethod == 'cod' ? __('Spot Payment') : ucfirst($app->paymentmethod) }}
                                            </td>
            ...
            <div class="row align-items-end">
                <div class="col-lg-8">
                    <div class="page-header-title">
                        ...
                        <div class="d-inline">
                            <h5>{{ __('Chart') }}</h5>
                            <span>{{ __('Doctor patient earning by Year') }}</span>
                        </div>
                    </div>
                </div>
            </div>
