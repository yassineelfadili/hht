...
<h5>{{auth()->user()->name}}</h5>
    ...
    <table class="table table-bordered">
        ...
        <tr>
            ...
            <td>{{$fm->appdate}}</td>
            <td>{{$fm->type == OFFLINE ? __('main.Offline') : __('main.Online')}}</td>
    ...
    @forelse ($second_month as $sm)
        <tr>
            ...
            <td>{{$sm->appdate}}</td>
            <td>{{$sm->type == OFFLINE ? __('main.Offline') : __('main.Online')}}</td>
...
<table class="table table-bordered">
    ...
    @forelse ($third_month as $tm)
        <tr>
            ...
            <td>{{$tm->appdate}}</td>
            <td>{{$tm->type == OFFLINE ? __('main.Offline') : __('main.Online')}}</td>
...
<table class="table table-bordered">
    ...
    @forelse ($fourth_month as $frm)
        <tr>
            ...
            <td>{{$frm->appdate}}</td>
            <td>{{$frm->type == OFFLINE ? __('main.Offline') : __('main.Online')}}</td>
...
<table class="table table-bordered">
    ...
    @forelse ($fifth_month as $ffm)
        <tr>
            ...
            <td>{{$ffm->appdate}}</td>
            <td>{{$ffm->type == OFFLINE ? __('main.Offline') : __('main.Online')}}</td>
...
<table class="table table-bordered">
    ...
    @forelse ($sixth_month as $sxm)
        <tr>
            ...
            <td>{{$sxm->appdate}}</td>
            <td>{{$sxm->type == OFFLINE ? __('main.Offline') : __('main.Online')}}</td>
...
<table class="table table-bordered">
    ...
    @forelse ($seventh_month as $svm)
        <tr>
            ...
            <td>{{$svm->appdate}}</td>
            <td>{{$svm->type == OFFLINE ? __('main.Offline') : __('main.Online')}}</td>
...
<table class="table table-bordered">
    ...
    @forelse ($eighth_month as $etm)
        <tr>
            ...
            <td>{{$etm->appdate}}</td>
            <td>{{$etm->type == OFFLINE ? __('main.Offline') : __('main.Online')}}</td>
...
<table class="table table-bordered">
    ...
    @forelse ($ninth_month as $nnm)
        <tr>
            ...
            <td>{{$nnm->appdate}}</td>
            <td>{{$nnm->type == OFFLINE ? __('main.Offline') : __('main.Online')}}</td>
...
<table class="table table-bordered">
    ...
    @forelse ($tenth_month as $tnm)
        <tr>
            ...
            <td>{{$tnm->appdate}}</td>
            <td>{{$tnm->type == OFFLINE ? __('main.Offline') : __('main.Online')}}</td>
...
<table class="table table-bordered">
    ...
    @forelse ($eleventh_month as $elvm)
        <tr>
            ...
            <td>{{$elvm->appdate}}</td>
            <td>{{$elvm->type == OFFLINE ? __('main.Offline') : __('main.Online')}}</td>
...
<table class="table table-bordered">
    ...
    @forelse ($tweleveth_month as $twlm)
        <tr>
            ...
            <td>{{$twlm->appdate}}</td>
            <td>{{$twlm->type == OFFLINE ? __('main.Offline') : __('main.Online')}}</td>
