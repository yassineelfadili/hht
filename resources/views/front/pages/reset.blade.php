            ...
            <div class="row align-items-center">
                ...
                <div class="col-md-6">
                    <div class="register-form">
                        <h2 class="form-title">{{ __('main.Reset Password') }}</h2>
                        ...
                        <form method="POST" action="{{ route('resetpasswordpost', $token) }}">
                            ...
                            <div class="form-group">
                                <input type="password" class="form-control" id="password" name="password" placeholder="{{ __('main.Enter New Password') }}" />
                                <i class="fas fa-lock envelope form-icon"></i>
                            </div>
                            <div class="form-group">
                                <input type="password" class="form-control" id="confirm_password" name="confirm_password" placeholder="{{ __('main.Enter Confirm Password') }}" />
                                <i class="fas fa-lock envelope form-icon"></i>
                            </div>
                            <div class="form-bottom">
                                <button type="submit" class="primary-btn">{{ __('main.Reset Password') }}</button>
                            </div>
                        </form>
                    </div>
                </div>
