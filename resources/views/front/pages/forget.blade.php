...
<section class="breadcrumb-area cus-bg-img"  style="background-image: url({{ asset(path_page_banner() . $allsettings['banner']) }})">
    <div class="container">
        <h2 class="page-title">{{ __('main.Forget Password') }}</h2>
        <ul class="breadcrumb-page">
            <li><a href="{{ route('front.index') }}">{{ __('main.Home') }}</a></li>
            <li>{{ __('main.Forget Password') }}</li>
        </ul>
    </div>
</section>
            ...
            <div class="row align-items-center">
                ...
                <div class="col-md-6">
                    <div class="register-form">
                        <h2 class="form-title">{{ __('main.Forget Password') }}</h2>
                        ...
                        <form method="POST" action="{{ route('forget-pass') }}">
                            ...
                            <div class="form-bottom">
                                <button type="submit" class="primary-btn">{{ __('main.Forget Password') }}</button>
                            </div>
                        </form>
                    </div>
                </div>
