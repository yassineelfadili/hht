                            ...
                            @else
                                @if (Auth::user()->role == 'doctor')
                                    <a class="common-tbl-btn create-button" role="button" data-toggle="modal"
                                        data-target="#MakePrescription{{ $app->id }}">{{ __('main.Make Prescription') }}</a>
                                @else
                                    <a class="common-tbl-btn disabled-btn" href="javascript:void(0)"
                                        role="button">{{ __('main.No Prescription') }}</a>
                                @endif
                            ...
                            <div id="collapse2{{ $app->id }}" class="collapse"
                                ...
                                <div class="card-body d-flex">
                                    <div>
                                        ...
                                        <div class="show-details-content-item">
                                            {{ __('main.Appointment Time:') }}<span>{{ $app->slot ? Carbon\Carbon::parse($app->slot->start_time)->format('H:i A') : 'N/A' }}-{{ $app->slot ? Carbon\Carbon::parse($app->slot->end_time)->format('H:i A') : 'N/A' }}</span>
                                        </div>
                                        <div class="show-details-content-item">
