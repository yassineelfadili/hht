...
@section('content')
    ...
    <section class="breadcrumb-area cus-bg-img"
        ...
        <div class="container">
            <h2 class="page-title">
                {{ Auth::user()->role == 'doctor' ? __('main.Doctor Dashboard') : __('main.Stuff Dashboard') }}</h2>
                                    ...
                                    <li class="nav-item" role="presentation">
                                        <a class="nav-link {{ isset($tab) && $tab == 'today-appointments' ? 'active' : '' }}"
                                            ...
                                            <i class="fas fa-calendar-check"></i> <span>
                                                {{ __('main.Today Appointments') }}</span>
                                        </a>
                                    </li>
                                    <li class="nav-item" role="presentation">
                                    ...
                                    @if (Auth::check() && Auth::user()->role == 'doctor')
                                        <li class="nav-item" role="presentation">
                                            <a class="nav-link" id="tabfive-tab" data-toggle="tab" href="#tabfive"
                                                ...
                                                <i
                                                    class="fas fa-address-book"></i><span>{{ __('main.Add Stuff') }}</span>
                                            </a>
                                        </li>
                                        <li class="nav-item" role="presentation">
                                            <a class="nav-link" id="tabseven-tab" data-toggle="tab" href="#tabseven"
                                                ...
                                                <i
                                                    class="fas fa-address-book"></i><span>{{ __('main.Manage Stuff') }}</span>
                                            </a>
                                        </li>
                                    @endif
                                    @if (Auth::check() && Auth::user()->role == 'stuff')
                                        <li class="nav-item" role="presentation">
                                            <a class="nav-link" id="tabsix-tab" data-toggle="tab" href="#tabsix"
                                                ...
                                                <i
                                                    class="fas fa-address-book"></i><span>{{ __('main.Create Appointment') }}</span>
                                            </a>
                                        </li>
                                    @endif
                ...
                <div class="tab-content" id="DashboardTabContent">
                    <div class="tab-pane fade {{ isset($tab) && $tab == 'dashboard' ? 'show active' : '' }}"
                                    ...
                                    <div class="single-box">
                                        <div class="media align-items-center">
                                            ...
                                            <div class="media-body">
                                                <h4 class="counter-title mt-0">{{ __('main.Total Patient') }}</h4>
                                    ...
                                    <div class="single-box">
                                        <div class="media align-items-center">
                                            <img src="{{ asset('front/assets/images/box-image-13.png') }}"
                                                class="box-image mr-4" alt="{{ __('box image') }}" />
                                            <div class="media-body">
                                                <h4 class="counter-title mt-0">{{ __('main.Pending Patient') }}</h4>
                                    ...
                                    <div class="single-box">
                                        <div class="media align-items-center">
                                            <img src="{{ asset('front/assets/images/box-image-7.png') }}"
                                                class="box-image mr-4" alt="{{ __('box image') }}" />
                                            <div class="media-body">
                                                <h4 class="counter-title mt-0">{{ __('main.Total Earnings') }}</h4>
                                    ...
                                    <div class="single-box">
                                        <div class="media align-items-center">
                                            <img src="{{ asset('front/assets/images/box-image-12.png') }}"
                                                class="box-image mr-4" alt="{{ __('box image') }}" />
                                            <div class="media-body">
                                                <h4 class="counter-title mt-0">{{ __('main.Patient') }}
                                                    ({{ now()->format('F') }})</h4>
                                    ...
                                    <div class="single-box">
                                        <div class="media align-items-center">
                                            <img src="{{ asset('front/assets/images/box-image-11.png') }}"
                                                class="box-image mr-4" alt="{{ __('box image') }}" />
                                            <div class="media-body">
                                                <h4 class="counter-title mt-0">{{ __('main.Earnings') }}
                                                    ({{ now()->format('F') }})</h4>
                                                @if (auth()->user()->role == 'doctor')
                                    ...
                                    <div class="single-box">
                                        <div class="media align-items-center">
                                            <img src="{{ asset('front/assets/images/box-image-10.png') }}"
                                                class="box-image mr-4" alt="{{ __('box image') }}" />
                                            <div class="media-body">
                                                <h4 class="counter-title mt-0">{{ __('main.Online') }}
                                                    ({{ now()->format('F') }})</h4>
                                                @if (auth()->user()->role == 'doctor')
                                        ...
                                        <div class="single-box report-box">
                                            <div class="media align-items-center">
                                                <img src="{{ asset('front/assets/images/box-image-8.png') }}"
                                                    class="box-image mr-4" alt="{{ __('box image') }}" />
                                                <div class="media-body">
                                                    <h4 class="counter-title mt-0">{{ __('main.Financial Report') }}
                                                    </h4>
                                                </div>
                                            </div>
                                        </div>
                        ...
                        <div class="section-heading-area section-heading-area-dashboard">
                            <h2 class="section-title">{{ __('main.Appointment Requests') }}</h2>
                        </div>
                                                ...
                                                <div class="input-wrap">
                                                    <div class="search-input">
                                                        <input type="text" class="form-control"
                                                            ...
                                                            placeholder="{{ __('main.Search Your Appointment') }}" />
                                ...
                                <div class="row">
                                    <div class="col-xl-10 offset-xl-1">
                                        <div class="row">
                                            <div class="col-12">
                                                <div class="section-heading-area">
                                                    <h2 class="section-title">{{ __('main.Add Stuff') }}</h2>
                                                </div>
                                                ...
                                                <form method="POST" action="{{ route('stuff.add') }}">
                                                            ...
                                                            <div class="col-md-6 mb-4">
                                                                <div class="input-group">
                                                                    ...
                                                                    <input type="text" name="fname"
                                                                        class="form-control"
                                                                        placeholder="{{ __('main.First name') }}">
                                                                </div>
                                                            </div>
                                                            <div class="col-md-6 mb-4">
                                                                <div class="input-group">
                                                            ...
                                                            <div class="col-md-6 mb-4">
                                                                <div class="input-group mb-0 position-relative">
                                                                    ...
                                                                    <input class="form-control" name="confirm_password"
                                                                        id="passConfirmInput"
                                                                        placeholder="{{ __('main.Confirm Password') }}d"
                                                                        type="password">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-12">
                                                            <button type="submit"
                                                                class="btn btn-primary">{{ __('main.Save Stuff') }}</button>
                                                        </div>
                                                    </div>
                                                </form>
                                ...
                                <div class="row">
                                    <div class="col-xl-10 offset-xl-1">
                                        <div class="row">
                                            <div class="col-12">
                                                <div class="section-heading-area">
                                                    <h2 class="section-title">{{ __('main.Create Appointment') }}</h2>
                                                </div>
                                                ...
                                                <form action="{{ route('stuff.create_appointment') }}" method="POST">
                                                            ...
                                                            <div class="col-md-12 mb-4">
                                                                <div class=" mb-0 position-relative">
                                                                    <textarea name="comment" class="stuff-create-appointment-" cols="30" rows="10"
                                                                        placeholder="{{ __('main.Write something') }}"></textarea>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="row">
                                                        <div class="col-md-12">
                                                            <button type="submit"
                                                                class="btn btn-primary">{{ __('main.Create Appointment') }}</button>
                                                        </div>
                                                    </div>
                                                </form>
                    ...
                    <div class="tab-pane fade" id="tabseven" role="tabpanel" aria-labelledby="tabseven-tab">
                        <div class="section-heading-area">
                            <h2 class="section-title">{{ __('main.Manage Stuff') }}</h2>
                        </div>
                        <div class="primary-table">
                            <div class="table-responsive">
                                <table class="table">
                                                ...
                                                <td colspan="3">
                                                    <div>
                                                        <img class="img-fluid w-100"
                                                            src="{{ asset('uploaded_file/no-data.png') }}"
                                                            alt="{{ __('image') }}">
                                                    </div>
                                                </td>
                                            </tr>
                    ...
                    <div class="edite-profile-area">
                        <div class="primary-form">
                            <form action="{{ route('user.profile', auth()->user()->id) }}" method="POST"
                                ...
                                <h4 class="form-inner-title">{{ __('main.Birthday') }}</h4>
                                <div class="row align-items-center">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                ...
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <h4 class="form-inner-title">{{ __('main.About Yourself') }}</h4>
                    ...
                    <div class="modal-body">
                        <div class="prescription-wrap">
                            <div class="prescription-top">
                                <h2 class="section-title">{{ __('main.All Appointment') }}
                                    <span>{{ __('main.Make Prescription') }}</span>
                                </h2>
                                        ...
                                        <form action="{{ route('prescription', $app->id) }}" method="POST">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <div class="patient-info d-flex flex-wrap flex-row">
                                                            <div class="sigle-info">
                                                                <span>{{ __('main.Patient Name') }}</span>
                                                                <h4>{{ $app->patient->name }}</h4>
                                                            </div>
                                                            <div class="sigle-info">
                                                                <span>{{ __('main.Patient ID') }}</span>
                                                ...
                                                <div class="form-top mb-30">
                                                    <div class="row">
                                                        {{-- <div class="col-lg-3 col-md-6 col-sm-6">
                                                            <div class="form-group">
                                                                <label>{{ __('main.Patient Type') }}</label>
                                                                <select class="form-control">
                                                                    <option>{{ __('main.Returning') }}</option>
                                                                    <option>{{ __('main.new') }}</option>
                                                                </select>
                                                            </div>
                                                        </div> --}}
                                                        <div class="col-lg-3 col-md-6 col-sm-6">
                                                            <div class="form-group">
                                                                <label>{{ __('main.Patient Weight') }}</label>
                                                        ...
                                                        <div class="col-lg-3 col-md-6 col-sm-6">
                                                            <div class="form-group">
                                                                <label
                                                                    for="PatientBP">{{ __('main.Patient BP') }}</label>
                                                        ...
                                                        <div class="col-lg-3 col-md-6 col-sm-6">
                                                            <div class="form-group">
                                                                <label
                                                                    for="PatientTemperature">{{ __('main.Patient Temperature') }}</label>
                                            ...
                                            <div class="prescription-body">
                                                <div class="medicine-area mb-40">
                                                            ...
                                                            <table class="table table-borderless" id="medicine_table">
                                                                ...
                                                                <tbody id="medicine">
                                                                    @if ($errors->any())
                                                                        <div id="error-box">
                                                                            <p class="text-danger">
                                                                                {{ __('main.Please fill up all the field') }}
                                                                            </p>
                                                                        </div>
                                                                    @endif
                                                                </tbody>
                                                    ...
                                                    <a class="add-btn" id="add-tablebtn" href="javascript:void(0)"><i
                                                            class="fas fa-plus"></i>{{ __('main.Add') }}</a>
                                                </div>
                                                ...
                                                <div class="advice-area mt-3 mb-40">
                                                    <div class="form-group">
                                                        <label for="advice">{{ __('main.Advice') }}</label>
                                                        <input type="text" class="form-control" id="advice"
                                                            name="advice" placeholder="{{ __('Advice') }}"
                                                            required />
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="prescription-footer text-right">
                                                <button id="presBtnSubmit"
                                                    class="primary-btn mr-2">{{ __('main.Confirm') }}</button>
                                            </div>
                                        </form>
                                    </div>
                                </div>
                                ...
                                <div id="printable">
                                    ...
                                    <div class="prescription-body ">
                                        <div class="prescription-info mb-30">
                                            <h3 class="prescription-section-title mb-3">{{ __('main.Medicine:') }}</h3>
                                            <div class="primary-table">
                                                <div class="table-responsive">
                                                    <table class="table table-borderless">
                                                        <thead>
    ...
    @foreach ($appointment as $ap)
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLongTitle">{{ __('main.Cancel Appointment') }}</h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                    <form action="{{ route('cancel.appointment', $ap->id) }}" method="POST">
                        ...
                        <div class="modal-body">
                            <div class="form-group">
                                <label for="reason">{{ __('main.Reason') }}</label>
                                <textarea class="form-control create-meeting-info" id="reason" rows="3" name="reason"
                                    placeholder="{{ __('main.Write something') }}" required></textarea>
                            </div>
                            <button type="submit"
                                class="btn btn-primary create-meeting-info-button">{{ __('main.Cancel') }}</button>
                        </div>
                    </form>
                </div>
            </div>
        ...
        <div class="modal fade common-modal create-meeting-modal" id="createMeetingModal{{ $ap->id }}"
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLongTitle">{{ __('main.Create Meeting') }}</h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                    <form action="{{ route('doctor.zoom_create_link') }}" method="POST">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="create-meeting-info"><span>{{ __('main.Patient:') }}</span>
                                {{ $ap->patient->name }}</div>
