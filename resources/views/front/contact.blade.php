            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="address-ara mb-30">
                        <h3 class="address-title">{{ __('main.Contact Us') }}</h3>
                        <ul class="address-infno">
                            <li>
                                <div class="media">
                                    ...
                                    <div class="media-body">
                                        <h4 class="mt-0">{{ __('main.Our Location') }}</h4>
                            ...
                            <li>
                                <div class="media">
                                    ...
                                    <div class="media-body">
                                        <h4 class="mt-0">{{ __('main.Our Phone') }} </h4>
                            ...
                            <li>
                                <div class="media">
                                    ...
                                    <div class="media-body">
                                        <h4 class="mt-0"> {{ __('main.Our Email') }} </h4>
                        ...
                        <div class="support-area">
                            <h3><i class="flaticon-headphones"></i> {{ __('main.24 X 7 online support') }}</h3>
                        </div>
                    </div>
                </div>
                <div class="col-md-6">
            ...
            <div class="primary-form ">
                ...
                <form action="{{ route('front.contact.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control comment-box" id="message" name="massage" rows="3"
                                    placeholder="{{ __('main.Your Messages') }}"></textarea>
                        ...
                        <div class="col-lg-12">
                            <button type="submit" class="primary-btn">{{ __('main.Send Messages') }}</button>
                        </div>
                    </div>
                </form>
            </div>
