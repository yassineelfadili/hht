                    ...
                    <div class="single-widget contact-widget">
                        <div class="media align-items-center">
                            ...
                            <div class="media-body">
                                <h4 class="mt-0">{{ __('main.Call For Any Help') }}</h4>
                    ...
                    <ul class="pagination-wrap">
                        <li class="previous">
                            ...
                            <a href="{{ route('front.single.service', $previous_service->slug) }}">
                                <span> <i class="flaticon-left-arrow"></i> {{ __('main.Previous Services') }}</span>
                        ...
                        <li class="next">
                            ...
                            <a href="{{ route('front.single.service', $next_service->slug) }}">
                                <span>{{ __('main.Next Services') }}  <i class="flaticon-right-arrow"></i></span>
