                                ...
                                <div class="single-counter">
                                    <div class="media align-items-center">
                                        ...
                                        <div class="media-body">
                                            <h2 class="counter">{{ $counter_section->counter_one_count }}</h2>
                                            <p class="mb-0">{{ $counter_section->counter_one_title }}</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-6 col-md-6 col-sm-6">
                                <div class="single-counter">
                                    <div class="media align-items-center">
                                        ...
                                        <div class="media-body">
                                            <h2 class="counter">{{ $counter_section->counter_two_count }}</h2>
                                            <p class="mb-0">{{ $counter_section->counter_two_title }}</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-6 col-md-6 col-sm-6">
                                <div class="single-counter">
                                    <div class="media align-items-center">
                                        ...
                                        <div class="media-body">
                                            <h2 class="counter">{{ $counter_section->counter_three_count }}
                                            </h2>
                                            <p class="mb-0">{{ $counter_section->counter_three_title }}</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-6 col-md-6 col-sm-6">
                                <div class="single-counter">
                                    <div class="media align-items-center">
                                        ...
                                        <div class="media-body">
                                            <h2 class="counter">{{ $counter_section->counter_four_count }}
                                            </h2>
                                            <p class="mb-0">{{ $counter_section->counter_four_title }}</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
