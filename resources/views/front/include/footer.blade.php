            ...
            <div class="row align-items-center">
                ...
                <div class="col-md-8">
                    <div class="newsletter-area d-flex justify-content-between align-items-center">
                        <h3 class="newsletter-title">{{ __('main.Subscribe Newsletter') }}</h3>
                        <div>
                                ...
                                <form action="{{ route('subscriber.store') }}" method="POST">
                                    ...
                                    <div class="newsletter-wrape">
                                        <input type="text" name="email" class="newsletter-input"
                                            placeholder="{{ __('main.Enter your Email Here...') }}" />
            ...
            <div class="row">
                <div class="col-lg-4 col-md-6 col-sm-6">
                    <div class="single-widget text-widget">
                        <h3 class="widget-title">{{ __('main.Get In Touch') }}</h3>
                    ...
                    <div class="single-widget menu-widget">
                        ...
                        <ul>
                            @foreach (quick_links_menu() as $quick_links_menu)
                                <li>
                                    <a
                                        href="{{ url($quick_links_menu->url) }}">{{ __($quick_links_menu->label) }}</a>
                                </li>
                            @endforeach
                        </ul>
                    </div>
                    ...
                    <div class="single-widget menu-widget">
                        ...
                        <ul>
                            @foreach (support_help_menu() as $support_help_menu)
                                <li>
                                    <a
                                        href="{{ url($support_help_menu->url) }}">{{ __($support_help_menu->label) }}</a>
                                </li>
                            @endforeach
                        </ul>
                    </div>
                    ...
                    <div class="single-widget galley-widget">
                        ...
                        <ul>
                            @foreach (footer_gallery() as $footer_gallery)
                                <li>
                                    <a href="{{ route('front.single.service', $footer_gallery->service->slug) }}">
