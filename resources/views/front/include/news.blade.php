                        ...
                        <div class="single-grid-blog">
                            ...
                            <div class="blog-info">
                                <h3 class="blog-title"><a
                                        href="{{ route('front.single.news', $news->slug) }}">{{ $news->title }}</a>
                                </h3>
                                <ul class="blog-meta">
                                    <li>
                                ...
                                <a class="redmore-btn"
                                    href="{{ route('front.single.news', $news->slug) }}">{{ __('Read More') }}</a>
                            </div>
                        </div>
                    @endif
                @endforeach
                    ...
                    @if ($loop->iteration > 1)
                        <div class="single-grid-blog">
                            <div class="blog-info">
                                ...
                                <p class="blog-content">{{ $news->description }}</p>
                                <a class="redmore-btn"
                                    href="{{ route('front.single.news', $news->slug) }}">{{ __('main.Read More') }}</a>
                            </div>
                        </div>
                    @endif
                @endforeach
                <div class="view-more-btn">
                    <a class="primary-btn" href="{{ route('front.news') }}">{{ __('main.More View') }}</a>
                </div>
            </div>
        </div>
    </div>
