                ...
                <div class="col-6">
                    <div class="page-header-title">
                        ...
                        <div class="d-inline">
                            ...
                            <span>{{ __('List of testimonials') }}</span>
                        </div>
                    </div>
                </div>
                <div class="col-6">
                    ...
                    <div class="card-header">
                        ...
                        @can('testimonial-create')
                            <a class="btn btn-primary ml-auto"
                                href="{{ route('testimonial.create') }}">{{ __('Add Testimonial') }}</a>
                        @endcan
                    </div>
                    <div class="card-body">
                        {{ $dataTable->table() }}
                            ...
                            @foreach (allLanguages() as $lang)
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="title" name="title_{{ $lang->prefix }}"
                                        ...
                                        value="{{ section_title('testimonial-section') ? section_title('testimonial-section')->translateOrDefault($lang->prefix)->title : '' }}">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea id="description" name="description_{{ $lang->prefix }}" class="form-control"
                                        rows="5">{{ section_title('testimonial-section') ? section_title('testimonial-section')->translateOrDefault($lang->prefix)->description : '' }}</textarea>
