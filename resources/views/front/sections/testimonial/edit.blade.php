                        ...
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="name" name="name"
                                    placeholder="{{ __('Name here') }}" value="{{ $testimonial->name }}">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="occupation" name="occupation"
                                    placeholder="{{ __('Occupation here') }}" value="{{ $testimonial->occupation }}">
                                <span class="text-danger">{{ __($errors->first('occupation')) }}</span>
                            </div>
                            <div class="form-group">
                                <label for="title">{{ __('Title') }} <span class="text-danger">*</span></label>
                                <input type="text" class="form-control" id="title" name="title"
                                    placeholder="{{ __('Title here') }}" value="{{ $testimonial->title }}">
                            ...
                            <div class="form-group">
                                ...
                                <textarea id="description" name="description"
                                    class="form-control html-editor">{{ $testimonial->description }}</textarea>
                        ...
                        <div class="card-body">
                            <div class="image-group">
                                <div class="form-group">
                                    ...
                                    <img id="target" class="cus-mw-200"
                                        src="{{ asset(path_testimonial_image() . $testimonial->image) }}"
                                        alt="{{ __('image') }}">
                                </div>
                                <div class="form-group">
                                    <div class="input-group">
                                        <div class="custom-file">
                                            <input name="image" onchange="putImage(this, 'target')" type="file"
                                                class="custom-file-input" id="validatedInputGroupCustomFile1">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control select2" name="star">
                                    <option value="1" {{ $testimonial->star == 1 ? 'selected' : '' }}>
                                        {{ __('One') }}</option>
                                    <option value="2" {{ $testimonial->star == 2 ? 'selected' : '' }}>
                                        {{ __('Two') }}</option>
                                    <option value="3" {{ $testimonial->star == 3 ? 'selected' : '' }}>
                                        {{ __('Three') }}</option>
                                    <option value="4" {{ $testimonial->star == 4 ? 'selected' : '' }}>
                                        {{ __('Four') }}</option>
                                    <option value="5" {{ $testimonial->star == 5 ? 'selected' : '' }}>
                                        {{ __('Five') }}</option>
                                </select>
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control select2" name="status">
                                    <option value="1" {{ $testimonial->status == 1 ? 'selected' : '' }}>
                                        {{ __('Publish') }}</option>
                                    <option value="2" {{ $testimonial->status == 2 ? 'selected' : '' }}>
                                        {{ __('Draft') }}</option>
                                </select>
