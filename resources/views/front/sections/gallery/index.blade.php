                    ...
                    <div class="card-body">
                        @foreach (allLanguages() as $lang)
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="title" name="title_{{$lang->prefix}}" placeholder="{{ __('Title here') }}" value="{{ section_title('gallery-section') ? section_title('gallery-section')->translateOrDefault($lang->prefix)->title : '' }}">
