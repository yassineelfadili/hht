                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            @foreach (allLanguages() as $lang)
                                <div class="form-group">
                                    <label for="counter_one_count">{{ __('Count('.$lang->name.')') }} <span class="text-danger">*</span></label>
                                    <input type="text" class="form-control" id="counter_one_count" name="counter_one_count_{{$lang->prefix}}" placeholder="{{ __('Description here') }}" value="{{ !empty($counter) ? $counter->translateOrDefault($lang->prefix)->counter_one_count : '' }}">
                                    <span class="text-danger">{{ __($errors->first('counter_one_count')) }}</span>
                                </div>
                                <div class="form-group">
                                    <label for="counter_one_title">{{ __('Title('.$lang->name.')') }} <span class="text-danger">*</span></label>
                                    <input type="text" class="form-control" id="counter_one_title" name="counter_one_title_{{$lang->prefix}}" placeholder="{{ __('Title here') }}" value="{{ !empty($counter) ? $counter->translateOrDefault($lang->prefix)->counter_one_title : '' }}">
                            ...
                            @foreach (allLanguages() as $lang)
                            <div class="form-group">
                                <label for="counter_two_count">{{ __('Count('.$lang->name.')') }} <span class="text-danger">*</span></label>
                                <input type="text" class="form-control" id="counter_two_count" name="counter_two_count_{{$lang->prefix}}" placeholder="{{ __('Description here') }}" value="{{ !empty($counter) ? $counter->translateOrDefault($lang->prefix)->counter_two_count : '' }}">
                                <span class="text-danger">{{ __($errors->first('counter_two_count')) }}</span>
                            </div>
                            <div class="form-group">
                                <label for="counter_two_title">{{ __('Title('.$lang->name.')') }} <span class="text-danger">*</span></label>
                                <input type="text" class="form-control" id="counter_two_title" name="counter_two_title_{{$lang->prefix}}" placeholder="{{ __('Title here') }}" value="{{ !empty($counter) ? $counter->translateOrDefault($lang->prefix)->counter_two_title : '' }}">
                            ...
                            @foreach (allLanguages() as $lang)
                            <div class="form-group">
                                <label for="counter_three_count">{{ __('Count('.$lang->name.')') }} <span class="text-danger">*</span></label>
                                <input type="text" class="form-control" id="counter_three_count" name="counter_three_count_{{$lang->prefix}}" placeholder="{{ __('Description here') }}" value="{{ !empty($counter) ? $counter->translateOrDefault($lang->prefix)->counter_three_count : '' }}">
                                <span class="text-danger">{{ __($errors->first('counter_three_count')) }}</span>
                            </div>
                            <div class="form-group">
                                <label for="counter_three_title">{{ __('Title('.$lang->name.')') }} <span class="text-danger">*</span></label>
                                <input type="text" class="form-control" id="counter_three_title" name="counter_three_title_{{$lang->prefix}}" placeholder="{{ __('Title here') }}" value="{{ !empty($counter) ? $counter->translateOrDefault($lang->prefix)->counter_three_title : '' }}">
                            ...
                            @foreach (allLanguages() as $lang)
                            <div class="form-group">
                                <label for="counter_four_count">{{ __('Count('.$lang->name.')') }} <span class="text-danger">*</span></label>
                                <input type="text" class="form-control" id="counter_four_count" name="counter_four_count_{{$lang->prefix}}" placeholder="{{ __('Description here') }}" value="{{ !empty($counter) ? $counter->translateOrDefault($lang->prefix)->counter_four_count : '' }}">
                                <span class="text-danger">{{ __($errors->first('counter_four_count')) }}</span>
                            </div>
                            <div class="form-group">
                                <label for="counter_four_title">{{ __('Title('.$lang->name.')') }} <span class="text-danger">*</span></label>
                                <input type="text" class="form-control" id="counter_four_title" name="counter_four_title_{{$lang->prefix}}" placeholder="{{ __('Title here') }}" value="{{ !empty($counter) ? $counter->translateOrDefault($lang->prefix)->counter_four_title : '' }}">
