                    ...
                    <div class="card-header">
                        ...
                        @can('service-create')
                            <a class="btn btn-primary ml-auto"
                                href="{{ route('service.create') }}">{{ __('Add Service') }}</a>
                        @endcan
                    </div>
                    <div class="card-body">
                        {{ $dataTable->table() }}
                            ...
                            @foreach (allLanguages() as $lang)
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea id="description" name="description_{{ $lang->prefix }}" class="form-control"
                                        rows="5">{{ section_title('service-section') ? section_title('service-section')->translateOrDefault($lang->prefix)->description : '' }}</textarea>
