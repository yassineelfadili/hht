...
@section('title', __('Doctor Section'))
@section('content')
        ...
        <div class="row align-items-end">
            <div class="col-6">
                <div class="page-header-title">
                    ...
                    <div class="d-inline">
                        <h5>{{ __('Doctor')}}</h5>
                        <span>{{ __('Doctor section edit')}}</span>
                    </div>
                </div>
            </div>
            <div class="col-6">
                <nav class="breadcrumb-container" aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item">
                            <a href="javascript:void(0)">{{ __('Doctor')}}</a>
                        </li>
                    </ol>
                </nav>
            </div>
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <h3>{{ __('Doctor Section') }}</h3>
                    </div>
                    <div class="card-body">
                        @foreach (allLanguages() as $lang)
                            <div class="form-group">
                                <label for="title">{{ __('Title('.$lang->name.')') }} <span class="text-danger">*</span></label>
                                <input type="text" class="form-control" id="title" name="title_{{$lang->prefix}}" placeholder="{{ __('Title here') }}" value="{{ section_title('doctor-section') ? section_title('doctor-section')->translateOrDefault($lang->prefix)->title : '' }}">
