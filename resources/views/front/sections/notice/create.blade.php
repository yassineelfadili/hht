                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="icon" name="icon" placeholder="{{ __('Icon Class here') }}" value="flaticon-exclamation">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <input id="button_text" type="text" class="form-control" name="button_text" placeholder="{{ __('Button Text') }}" value="View Details">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" id="button_url" name="button_url" class="form-control" placeholder="{{ __('Button URL') }}" value="#">
