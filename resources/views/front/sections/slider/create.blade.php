                        ...
                        <div class="card-body">
                            ...
                            @foreach (allLanguages() as $lang)
                                <div class="form-group">
                                    ...
                                    <textarea id="small_heading" name="small_heading_{{$lang->prefix}}" class="form-control" rows="4"></textarea>
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea id="big_heading" name="big_heading_{{$lang->prefix}}" class="form-control" rows="4"></textarea>
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea id="description" name="description_{{$lang->prefix}}" class="form-control" rows="6"></textarea>
