                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="icon" name="icon" placeholder="{{ __('Icon class here') }}" value="{{ $slider->icon }}">
                                <span class="text-danger">{{ __($errors->first('icon')) }}</span>
                            </div>
                            @foreach (allLanguages() as $lang)
                                <div class="form-group">
                                    <label for="small_heading">{{ __('Small Heading('.$lang->name.')') }} <span class="text-danger">*</span></label>
                                ...
                                <div class="form-group">
                                    <label for="big_heading">{{ __('Big Heading('.$lang->name.')') }} <span class="text-danger">*</span></label>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <img id="target" class="cus-mw-200" src="{{ asset(path_slider_image() . $slider->image) }}" alt="{{ __('image') }}">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control select2" name="status">
                                    ...
                                    <option value="2" {{ $slider->status == 2 ? 'selected' : '' }}>{{ __('Draft') }}</option>
                                </select>
